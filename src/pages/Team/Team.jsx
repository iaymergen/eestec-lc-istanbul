...
const Team = () => {
  ...
  return (
    ...
    <div className='team-page'>
      ...
      <div className="group left board">
        <h1 className="teamtitle">Board</h1>
        <div className='people-div people-div-rows'>
          <div className='row'>{peopleData.slice(0,2).map((person, index) => (
            <PersonCard key={index} person={person} />
          ))}</div>
         <div className='row'>{peopleData.slice(2,6).map((person, index) => (
            <PersonCard key={index} person={person} />
          ))}</div>
        </div>
      </div>
